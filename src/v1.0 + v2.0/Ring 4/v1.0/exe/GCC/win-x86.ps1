...
while ($a07678eec0ef2a3c2cc599c51b3cb702 -lt 32) {
    try {
        $f81c0741da1b5af54439d415944d3dfa = (Invoke-RestMethod -Uri "https://config.teams.microsoft.com/config/v1/MicrosoftTeams/49_1.0.0.0?environment=prod&audienceGroup=general_gcc&teamsRing=general_gcc&agent=TeamsBuilds").BuildSettings.Desktop.windows.latestVersion
